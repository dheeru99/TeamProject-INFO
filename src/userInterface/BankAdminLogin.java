 ...
 * @author dheer
 */
public class BankAdminLogin extends javax.swing.JPanel {
...
JPanel rightLayout;
    ...
    public BankAdminLogin(JPanel rightLayout, SystemAdmin sysAdmin) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("BANK ADMIN LOGIN");
        add(jLabel1);
     ...
     Statement st= cn.createStatement();
      ...
      String id="";
       ...
       if(!un.matches("")){ 
                if(!pass.matches("")){
                    clear();
        BankAdmin directory = new BankAdmin(rightLayout,userDirectory,id);
        rightLayout.add("BankAdmin",directory);
