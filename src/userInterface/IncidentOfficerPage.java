        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(txt3, javax.swing.GroupLayout.PREFERRED_SIZE, 253, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
            ...
            if(d>0){
                ...
                if(fine.matches("")){
                    ...
                    try{
                        ...
                        content= "Hi "+name+",\n"
                        + "\n"
                        + "We have searched for the victims in the incident area the situation. We didn't find any disturbance or break in happened in this area. So, Due to inappropriate report we are raising a fine of "+fine+" CAD againt your account. If you have any queries please visit the emergency website.\n"
                        + "\n"
                        + "Thanks and Regards,\n"
                        + ""+orgName+"\n"
                        + ""+id+"\n"
