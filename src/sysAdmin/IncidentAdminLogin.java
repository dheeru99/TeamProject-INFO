 ...
 * @author dheer
 */
public class IncidentAdminLogin extends javax.swing.JPanel {
...
JPanel rightLayout;
    ...
    public IncidentAdminLogin(JPanel rightLayout, SystemAdmin sysAdmin) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("INCIDENT ADMIN LOGIN");
        add(jLabel1);
     ...
     Statement st= cn.createStatement();
      ...
      String id="";
       ...
       if(!un.matches("")){ 
                if(!pass.matches("")){
                    clear();
        IncidentAdmin directory = new IncidentAdmin(rightLayout,userDirectory,id);
        rightLayout.add("IncidentAdmin",directory);
