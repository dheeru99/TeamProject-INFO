 ...
 * @author dheer
 */
public class IncidentOfficerLogin extends javax.swing.JPanel {

    /**
     * Creates new form IncidentOfficerLogin
     */
    JPanel rightLayout;
    SystemAdmin sysAdmin;
    public IncidentOfficerLogin(JPanel rightLayout,SystemAdmin sysAdmin ) {
    ...
    private void initComponents() {
        ...
        add(txt1);
        txt1.setBounds(540, 70, 250, 40);

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 51, 51));
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("INCIDENT OFFICER LOGIN");
        add(jLabel1);
        jLabel1.setBounds(240, 20, 550, 40);

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel2.setText(":");
        add(jLabel2);
        jLabel2.setBounds(510, 70, 13, 40);

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 51, 51));
        jLabel3.setText("USERNAME");
        add(jLabel3);
        jLabel3.setBounds(310, 70, 200, 40);

        jLabel4.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 51, 51));
        jLabel4.setText("PASSWORD");
        add(jLabel4);
        jLabel4.setBounds(310, 120, 200, 40);

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel5.setText(":");
        add(jLabel5);
        jLabel5.setBounds(510, 120, 13, 40);
        add(txt2);
        txt2.setBounds(540, 120, 250, 40);
        ...
        add(jButton2);
        jButton2.setBounds(660, 180, 100, 40);
        ...
        add(jButton1);
        jButton1.setBounds(540, 180, 100, 40);
        ...
        add(jButton3);
        jButton3.setBounds(310, 240, 100, 40);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            String sql = "select * from INCIDENT_OFFICER_LOGIN";
            ...
            if(!un.matches("")){
                if(!pass.matches("")){
                    clear();
                    IncidentOfficerPage directory = new IncidentOfficerPage(rightLayout,id,name);
                    rightLayout.add("IncidentOfficerPage",directory);
