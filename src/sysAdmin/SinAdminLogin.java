 ...
 * @author dheer
 */
public class SinAdminLogin extends javax.swing.JPanel {
...
JPanel rightLayout;
    ...
    public SinAdminLogin(JPanel rightLayout, SystemAdmin sysAdmin) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("SIN ADMIN LOGIN");
        add(jLabel1);
     ...
     Statement st= cn.createStatement();
      ...
      String id="";
       ...
       if(!un.matches("")){ 
                if(!pass.matches("")){
                    clear();
        SinAdmin directory = new SinAdmin(rightLayout,userDirectory,id);
        rightLayout.add("SinAdmin",directory);
