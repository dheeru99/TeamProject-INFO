 ...
 * @author dheer
 */
public class BankManagerLogin extends javax.swing.JPanel {
    ...
    JPanel pageLayout;
    public BankManagerLogin(JPanel pageLayout,SystemAdmin sysAdmin) {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1);
        jLabel1.setBounds(620, 110, 550, 40);
        ...
        jPanel1.add(radio);
        radio.setBounds(1180, 210, 60, 40);
        jPanel1.add(txt2);
        txt2.setBounds(920, 210, 250, 40);
        ...
        jButton2.setBounds(1040, 270, 100, 40);

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel5.setText(":");
        jPanel1.add(jLabel5);
        jLabel5.setBounds(890, 210, 13, 40);

        jLabel4.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 51, 51));
        jLabel4.setText("PASSWORD");
        jPanel1.add(jLabel4);
        jLabel4.setBounds(690, 210, 200, 40);
        ...
        jPanel1.add(txt1);
        txt1.setBounds(920, 160, 250, 40);

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel2.setText(":");
        jPanel1.add(jLabel2);
        jLabel2.setBounds(890, 160, 13, 40);

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 51, 51));
        jLabel3.setText("USERNAME");
        jPanel1.add(jLabel3);
        jLabel3.setBounds(690, 160, 200, 40);
        ...
        jButton3.setBounds(920, 270, 100, 40);
        ...
        jButton4.setBounds(690, 270, 100, 40);
        ...
        bankLayout.add(jPanel1, "card2");

        add(bankLayout);
        bankLayout.setBounds(0, 0, 1980, 1080);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
     ...
     Statement st= cn.createStatement();
      String sql = "select * from BANK_MANAGER_LOGIN";
      ...
      String id="";
       ...
       if(String.valueOf(ps.getString("USERNAME")).matches(userName)){
           ...
           if(String.valueOf(ps.getString("PASSWORD")).matches(password)){
               ...
               id=String.valueOf(ps.getString("MANAGERID"));
           }
       }
       }
       if(!un.matches("")){ 
                if(!pass.matches("")){
                    clear();
        BankManagerPage directory = new BankManagerPage(pageLayout,userDirectory,id);
        pageLayout.add("BankManagerPage",directory);
